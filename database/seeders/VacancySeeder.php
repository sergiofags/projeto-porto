    ...
    public function run(): void
    {
        ...
        DB::table('vacancy')->insert([
            ...
            [
                ...
                'quantidade' => 2,
                'data_inicio' => Carbon::now()->addDays(7)->toDateString(),
                'data_fim' => Carbon::now()->addDays(37)->toDateString(),
                'tipo_vaga' => 'Graduacao',
                'status' => 'Aberto',
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                ...
                'data_fim' => Carbon::now()->addDays(40)->toDateString(),
                'tipo_vaga' => 'Graduacao',
                'status' => 'Aberto',
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                ...
                'quantidade' => 1,
                'data_inicio' => Carbon::now()->addDays(15)->toDateString(),
                'data_fim' => Carbon::now()->addDays(45)->toDateString(),
                'tipo_vaga' => 'Graduacao',
                'status' => 'Aberto',
                'created_at' => now(),
                'updated_at' => now(),
