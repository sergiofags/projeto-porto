                    ...
                    <div className="container mt-5 pl-2 pr-2">
                        <Table>
                            <ScrollArea className="h-[400px] w-full rounded-md border border-[#008DD0] p-4">
                                <TableHeader>
                                    <TableRow>
                                        <TableHead className="w-[500px] font-semibold">Processo</TableHead>
                                        <TableHead className="font-semibold">Data Início</TableHead>
                                        <TableHead className="font-semibold">Data Fim</TableHead>
                                        <TableHead className="font-semibold">Status</TableHead>
                                        <TableHead className="text-center align-middle font-semibold">Opções</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                    {[...process]
                                        ...
                                        .map((processo) => (
                                            <TableRow key={processo.numero_processo}>
                                                ...
                                                <TableCell className="text-center space-x-2 align-middle">
                                                    ...
                                                    <Link href={`/vacancy/visualizar-vaga?id=${processo.id}`}>
