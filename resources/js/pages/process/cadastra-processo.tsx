                        ...
                        <div className="tracking-wide max-w-md w-full break-words whitespace-normal">
                            ...
                            <form>
                                <div className="mb-3">
                                    ...
                                    <select id="status" name="status" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"  style={{width: '100%', paddingLeft: 10, paddingRight: 10, paddingTop: 20, paddingBottom: 20, background: 'white', boxShadow: '0px 4px 4px rgba(32, 127, 205, 0.43)', borderRadius: 10, border: '1px #207FCD solid'}} 
                                    />
